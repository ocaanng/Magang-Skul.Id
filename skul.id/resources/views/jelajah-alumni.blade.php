...
<!-- Jelajah Skul.Id Page -->
<div class="container my-5">
  <h4 class="fw-bold text-primary mb-3">
    <i class="bi bi-globe2 me-2"></i>Jelajah Skul.Id
  </h4>
  <p class="text-muted">Selesaikan misi harian dan kumpulkan koin untuk ditukarkan dengan hadiah menarik!</p>

  <div class="card p-3 mb-4">
    <div class="d-flex justify-content-between align-items-center">
      <div>
        <h5 class="fw-semibold mb-0">Total Koin Kamu:</h5>
        <div class="fs-4 text-warning fw-bold">120 <i class="bi bi-coin"></i></div>
      </div>
      <a href="#" class="btn btn-primary fw-semibold">Tukar Hadiah</a>
    </div>
  </div>
  ...
  <div class="row gy-4">
    ...
    <div class="col-md-6">
      <div class="card shadow-sm p-3">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            <h6 class="fw-bold">Baca 1 E-Book</h6>
            <p class="text-muted small mb-1">Selesaikan 1 bacaan e-book hari ini.</p>
            <span class="badge bg-warning text-dark">+10 Koin</span>
          </div>
          <button class="btn btn-success btn-sm">Klaim</button>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-6">
      <div class="card shadow-sm p-3">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            <h6 class="fw-bold">Baca 2 Artikel</h6>
            <p class="text-muted small mb-1">Temukan wawasan baru dari artikel Skul.id.</p>
            <span class="badge bg-warning text-dark">+15 Koin</span>
          </div>
    ...
    <div class="col-md-6">
      <div class="card shadow-sm p-3">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            <h6 class="fw-bold">Apply 2 Sertifikasi</h6>
            <p class="text-muted small mb-1">Ambil langkah untuk memperkuat CV-mu.</p>
            <span class="badge bg-warning text-dark">+20 Koin</span>
          </div>
          <button class="btn btn-success btn-sm">Klaim</button>
        </div>
      </div>
    ...
    <div class="col-md-6">
      <div class="card shadow-sm p-3">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            <h6 class="fw-bold">Masuk Setiap Hari</h6>
            <p class="text-muted small mb-1">Login harian untuk klaim bonus.</p>
            <span class="badge bg-warning text-dark">+5 Koin</span>
          </div>
          <button class="btn btn-success btn-sm">Klaim</button>
        </div>
      </div>
    ...
    <div class="col-md-6">
      <div class="card shadow-sm p-3">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            <h6 class="fw-bold">Ikuti 1 Pelatihan</h6>
            <p class="text-muted small mb-1">Tingkatkan kemampuanmu lewat pelatihan.</p>
            <span class="badge bg-warning text-dark">+25 Koin</span>
          </div>
          <button class="btn btn-success btn-sm" disabled>Selesai</button>
        </div>
      </div>
